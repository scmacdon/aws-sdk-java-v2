...
public interface TokenBucketExceptionCostCalculator extends Function<SdkException, Integer> {
    /**
     * Create an exception cost calculator using exception type matchers built into the SDK. This interface may be implemented
    ...
    interface Builder {
         ...
         * calculator is matched. This field is required.
         */
        Builder defaultExceptionCost(int cost);

        /**
         * Create a {@link TokenBucketExceptionCostCalculator} using the values configured on this builder.
         */
