...
@SdkInternalApi
public class DefaultTokenBucketExceptionCostCalculator implements TokenBucketExceptionCostCalculator {
    private final Integer throttlingExceptionCost;
    private final int defaultExceptionCost;

    private DefaultTokenBucketExceptionCostCalculator(Builder builder) {
    ...
    public boolean equals(Object o) {
        ...
        DefaultTokenBucketExceptionCostCalculator that = (DefaultTokenBucketExceptionCostCalculator) o;
    ...
    public static final class Builder implements TokenBucketExceptionCostCalculator.Builder {
        private Integer throttlingExceptionCost;
        private Integer defaultExceptionCost;

        public TokenBucketExceptionCostCalculator.Builder throttlingExceptionCost(int cost) {
            this.throttlingExceptionCost = cost;
            return this;
        }

        public TokenBucketExceptionCostCalculator.Builder defaultExceptionCost(int cost) {
            this.defaultExceptionCost = cost;
            return this;
        }

        public TokenBucketExceptionCostCalculator build() {
            return new DefaultTokenBucketExceptionCostCalculator(this);
        }
